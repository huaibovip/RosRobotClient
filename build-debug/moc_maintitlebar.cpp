...
QT_MOC_LITERAL(1, 13, 17), // "sendTitleBtnIndex"
...
QT_MOC_LITERAL(6, 115, 18) // "on_sendBtn_clicked"

    },
    "MainTitleBar\0sendTitleBtnIndex\0\0"
...
void MainTitleBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendTitleBtnIndex((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            using _t = void (MainTitleBar::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainTitleBar::sendTitleBtnIndex)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MainTitleBar::sendTitleBtnIndex(int _t1)
{
